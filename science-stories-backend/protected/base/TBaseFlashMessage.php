...
class TBaseFlashMessage extends TBaseWidget
{
            ...
            switch ($this->type) {
                case "default":
                    ...
                    foreach ($allMessage as $key => $message) {
                        ...
                        ?>
<div
	class="alert alert-<?= $class ?> alert-dismissable fade show m-t-10 d-flex justify-content-between">
	
								<?= $msg ?>
                                <a href="#" class="close"
		data-bs-dismiss="alert" aria-label="close">&times;</a>
</div>
<?php
                    }
                    break;

...
use app\modules\api\models\search\AccessToken as AccessTokenSearch;
 ...
 */
class AccessTokenController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = AccessToken::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing AccessToken model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'AccessToken Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }

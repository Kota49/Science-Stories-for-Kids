...
<div class="card-body">
   ...
   ?>
                  <?php /*echo $form->field($model, 'title')->textInput(['maxlength' => 256]) */ ?>
                              ...
                              <?php /*echo $form->field($model, 'role_type')->textInput() */ ?>
      ...
      <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Save') : Yii::t('app', 'Update'), ['id'=> 'push-notification-form-submit','class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
   </div>
   <?php TActiveForm::end(); ?>
</div>
...
class CriticalErrorWidget extends TBaseWidget
{
    ...
    public function isSchedulerStatusWorking()
    {
        ...
        $className = '\app\modules\scheduler\models\SettingsForm';
        ...
        $classNameLog = '\app\modules\scheduler\models\Log';
        if (! class_exists($classNameLog)) {
            return false;
        }
        $query = $classNameLog::find();

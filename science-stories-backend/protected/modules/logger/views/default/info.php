...
<div class="wrapper">
	<div class="card">
		<div class="log-view">	  <?=  \app\components\PageHeader::widget(['title' => 'System Info']); ?>	</div>
    ...
    echo \app\components\TDetailView::widget([
        ...
        'attributes' => [
            ...
            [
                'attribute' => 'Clean runtime and assets',
                'format' => 'raw',
                'value' => "<button class='btn btn-warning mr-3' id = 'clean-run' >
						<i class='fa fa-refresh'></i>Clean</button>
				</a>"
            ]
        ]
    ])?>
				...
				<div id="technical" class="tab-pane fade">
					...
					<iframe frameBorder="0"
						src="<?php echo Url::toRoute(['default/php-info'])?>" width="80%"
						height="500px"></iframe>
...
$(document).ready(function() {
	...
	$("#clean-run").click(function() {
	
        	$.ajax({
        	'type' : 'get',
        	'url' : '<?=Url::toRoute(['default/clear'])?>',

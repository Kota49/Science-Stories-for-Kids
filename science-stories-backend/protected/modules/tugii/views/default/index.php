...
$this->title = 'Welcome to TuGii';
?>

<div class="tugii-default-index">
    <h1 class="border-bottom pb-3 mb-3">Welcome to TuGii <small class="text-muted">a magical tool that can write code for you</small></h1>

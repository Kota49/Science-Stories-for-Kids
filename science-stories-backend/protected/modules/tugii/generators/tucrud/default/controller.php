...
<?php endif; ?>
    ...
    public function actionAdd(/* $id*/)
    {
       ...
       <?php  foreach ( $generator->modelClass::getHasOneRelations () as $field => $relationClass ) {?>
	'<?=$field?>' => <?=$relationClass[1]?>::class,
<?php }?>
        ]);
    ...
    public function actionClone(<?= $actionParams ?>)
    {
        ...
        foreach ($generator->getColumnNames() as $name) {
            if (preg_match('/^(id|user_id|password|created_on|state_id|created_by)/i', $name)) {

...
use app\modules\scheduler\models\Type as TypeModel;

/**
 * Type represents the model behind the search form about `app\modules\scheduler\models\Type`.
 */

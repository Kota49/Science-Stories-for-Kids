...
<div class="wrapper">
   <div class="card">
      <div class="help-support-view card-body">
   ...
   <div class="card">
      <div class="card-body">
         ...
         ?>         <div class="col-md-12 text-right">
            <?= Html::submitButton('Confirm', ['id'=> 'help-support-form-submit','class' =>'btn btn-success']) ?>
         </div>
         <?php TActiveForm::end(); ?>
      </div>
   </div>

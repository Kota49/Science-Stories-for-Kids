...
");
    ...
    <div class="col-md-6">
        ...
        <div class="position-relative">
            ...
            <?= Html::button('<i class="fa fa-copy"></i>', ['id' => 'buttonCopyText', 'class' => 'btn btn-success position-absolute', 'title' => 'Copy password']) ?>
        </div>
    ...
    <div class="col-md-6">
        ...
        <?php echo $form->field($model, 'encryption_type')->dropDownList($model->getEncryptionOptions(), ['prompt' => 'Select']) ?>
        <?php echo $form->field($model, 'limit_per_email')->textInput() ?>
        <?php if (User::isAdmin()) { ?>

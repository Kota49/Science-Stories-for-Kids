...
/**
 * This is the model class for table "tbl_help_support".
 *
 * @property integer $id
 ...
 */
class HelpSupport extends \app\components\TActiveRecord
{
    ...
    public function asJson($with_relations = false)
    {
        ...
        // } else {
        // $json['message'] = $this->getHebrewMessage();
        // }
        if (isset($this->image_file))
            $json['image_file'] = Url::toRoute('helpsupport/image', [
                'id' => $this->id,
    ...
    public static function addData($data)
    {
        ...
        foreach ($data as $item) {
            ...
            $model->message = isset($item['message']) ? $item['message'] : $faker->text;
    ...
    public function getHebrewMessage()
    {
        $data = ! empty($this->getTranslation('he', 'message', $this)) ? $this->getTranslation('he', 'message', $this) : '';

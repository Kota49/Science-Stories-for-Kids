 ...
 * @var app\models\search\HelpSupport $searchModel
 */
...
<?php Pjax::begin(['id'=>'help-support-pjax-ajax-grid','enablePushState'=>false,'enableReplaceState'=>false]); ?>
    <?php

echo TGridView::widget([
        'id' => 'help-support-ajax-grid-view',

         ...
         <tr>
            <td>
               ...
               <p style="margin: 20px 0 30px;">
                  <a href="<?= Html::encode($resetLink) ?>" style="background-color: #6eb356; border-radius: 3px; color: #fff;
                  display: inline-block;font-size:16px; font-weight: normal;
                  line-height: 40px; text-align: center; text-decoration: none; padding:0px 20px; -webkit-text-size-adjust: none;

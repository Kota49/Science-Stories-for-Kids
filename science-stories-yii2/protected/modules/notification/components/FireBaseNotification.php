...
class FireBaseNotification extends Component
{
    ...
    {
        parent::init();
        $this->authKey = \Yii::$app->settings->getValue('firebase_key', null, 'notification');
     ...
     * @return mixed
     */
    public function sendDataMessage($tokens = [], $data = null, $collapse_key = null, $delay_while_idle = null, $other = null)
    {

 ...
 */
class TranslatorController extends TController
{
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = Translator::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Translator model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Translator Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }

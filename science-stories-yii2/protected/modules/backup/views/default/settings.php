...
?>
			...
			<div class="row justify-content-center">
				<div class="col-xl-4 col-lg-6 col-md-6 custom-control custom-switch">
<?php
echo $form->field($model, 'allowDownload')
    ->checkbox([
    'id' => $model->getFormAttributeId('allowDownload'),
    'class' => 'custom-control-input',
    'onchange' => 'this.form.submit()'
])
    ->label(true, [
...
?>
			...
			<div class="row justify-content-center">
				<div class="col-xl-4 col-lg-6 col-md-6 custom-control custom-switch">
<?php
echo $form->field($model, 'lastBackupDateTime')
    ->textInput([
    'id' => $model->getFormAttributeId('lastBackupDateTime'),
    'class' => 'custom-control-input',
    'onchange' => 'this.form.submit()'
])
    ->label(true, [
...
?>
			...
			<div class="row justify-content-center">
				<div class="col-xl-4 col-lg-6 col-md-6 custom-control custom-switch">
<?php
echo $form->field($model, 'backupInterval')
    ->textInput([
    'id' => $model->getFormAttributeId('backupInterval'),
    'class' => 'custom-control-input',
    'onchange' => 'this.form.submit()'
])
    ->label(true, [

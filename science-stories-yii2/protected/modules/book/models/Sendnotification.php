...
/**
 * This is the model class for table "tbl_book_sendnotification".
 *
 * @property integer $id
 ...
 */
class Sendnotification extends \app\components\TActiveRecord
{
    ...
    {
        $list = self::getBookOptions();
        return isset($list[$this->book_id]) ? $list[$this->book_id] : 'Not Defined';
    }

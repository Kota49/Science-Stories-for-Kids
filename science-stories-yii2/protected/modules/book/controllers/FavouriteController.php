...
use app\modules\book\models\search\Favourite as FavouriteSearch;
use Yii;
...
class FavouriteController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Favourite::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Favourite model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Favourite Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }

...
use app\modules\book\models\search\Like as LikeSearch;
 ...
 */
class LikeController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Like::STATE_ACTIVE;
    ...
    /**
     * Truncate an existing Like model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Like Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }

...
use app\modules\scheduler\models\search\Log as LogSearch;
use Yii;
...
class LogController extends TController
{
    ...
    public function actionAdd(/* $id*/)
    {
        ...
        $model->state_id = Log::STATE_PENDING;
    ...
    public function actionClone($id)
    {
        ...
        $model = new Log();
        $model->loadDefaultValues();
        $model->state_id = Log::STATE_ACTIVE;

        // $model->id = $old->id;
        // $model->state_id = $old->state_id;
        $model->type_id = $old->type_id;
        $model->result = $old->result;
        $model->cronjob_id = $old->cronjob_id;
        $model->scheduled_on = $old->scheduled_on;
        $model->executed_on = $old->executed_on;

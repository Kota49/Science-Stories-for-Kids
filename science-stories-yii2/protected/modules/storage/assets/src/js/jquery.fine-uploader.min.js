...
! function(global) {
    ! function(e) {
        ...
        function i(e, t) {
            ...
            void 0 === n && (n = {}), n[e] = t, d.data("fineuploader", n)
        }
    ...
    function(e) {
        ...
        function n(e, t) {
            var n = u.data("fineUploaderDnd");
            if (!t) return void 0 === n ? null : n[e];
            void 0 === n && (n = {}), n[e] = t, u.data("fineUploaderDnd", n)
        }
        ...
        function s(e) {
            var t = [];
            return r(Array.prototype.slice.call(arguments, 1), t), i()[e].apply(i(), t)
        }
        var u;
    ...
    function() {
        ...
        qq.Error = function(e) {
            ...
            var u, l, c, d, p, h, f, q, m, g, _, v, b, y, S;
            ...
            }(), h = d && qq.isFileChunkingSupported(), f = d && h && a(), q = d && t(), m = u && (void 0 !== window.postMessage || d), _ = n(), g = i(), v = o(), b = r(), y = d && void 0 !== window.FileReader, S = function() {
        ...
        function() {
            ...
            function l(e, t) {
                var n, o = r(e, t),
                    ...
                    s = u(e),
                    l = y[e].payload;
                return S.onSend(e), n = c(e, s, y[e].additionalQueryParams), i(o) ? (o.onload = h(e), o.onerror = f(e)) : o.onreadystatechange = d(e), p(e), o.open(a, n, !0), S.cors.expected && S.cors.sendCredentials && !i(o) && (o.withCredentials = !0), q(e), _("Sending " + a + " request for " + e), l ? o.send(l) : v || !s ? o.send() : s && S.contentType && S.contentType.toLowerCase().indexOf("application/x-www-form-urlencoded") >= 0 ? o.send(qq.obj2url(s, "")) : s && S.contentType && S.contentType.toLowerCase().indexOf("application/json") >= 0 ? o.send(JSON.stringify(s)) : o.send(s), o
            }
            ...
            var n, i, o, r = this,
                ...
                l = {
                    ...
                    handleFailure: function(e, t, n, r) {
                        ...
                        if (h.reset) l.reset(t);
                        else {
                            var f = o._getFileState(t).chunking.inProgress;
                            d = f ? qq.indexOf(f, e) : -1, d >= 0 && (o._getFileState(t).chunking.inProgress.splice(d, 1), o._getFileState(t).chunking.remaining.unshift(e))
                        }
                    ...
                    sendNext: function(e) {
                        var t = u.getSize(e),
                            ...
                            f = d.chunking.inProgress || [];
                        if (null == d.loaded && (d.loaded = 0), h && u.onResume(e, n, a, d.customResumeData) === !1 && (l.reset(e), r = l.nextPart(e), a = o._getChunkData(e, r), h = !1), null == r && 0 === f.length) l.finalize(e);
                        else {
                            f.push(r), o._getFileState(e).chunking.inProgress = f, s && c.open(e, r), s && c.available() && o._getFileState(e).chunking.remaining.length && l.sendNext(e), 0 === a.blob.size && (i(qq.format("Chunk {} for file {} will not be uploaded, zero sized chunk.", r, e), "error"), l.handleFailure(r, e, "File is no longer available", null));
            ...
            function o(e, t) {
                var i = e.id,
                    o = n(i);
                l[f(o)] = t, c[o] = qq(e).attach("load", function() {
            ...
            qq.extend(this, new qq.UploadHandler(e)), qq.override(this, function(e) {
                ...
                _maybePrepareForResume: function(e) {
                    var t, i, o = n._getFileState(e);
                    l && void 0 === o.key && (t = n._getLocalStorageId(e), i = localStorage.getItem(t), i && (i = JSON.parse(i), f(i.uuid) ? n._markNotResumable(e) : (g(qq.format("Identified file with ID {} and name of {} as resumable.", e, c(e))), q(e, i.uuid), o.key = i.key, o.chunking = i.chunking, o.loaded = i.loaded, o.customResumeData = i.customResumeData, o.attemptingResume = !0, n.moveInProgressToRemaining(e))))
                },
        ...
        function() {
            ...
            function o(n, o, s, u, l) {
                ...
                return q.save(), u.resize ? r({
                    ...
                    origWidth: h,
                    origHeight: f
                }), c && (qq.log(qq.format("Had to reduce dimensions due to device limitations from {}w / {}h to {}w / {}h", h, f, c.newWidth, c.newHeight), "warn"), h = c.newWidth, f = c.newHeight)), a(s, h, f, u.orientation), qq.ios() ? function() {
                    e(n) && (d /= 2, p /= 2);
                    var i, o, r, a = 1024,
            ...
            qq.extend(this, {
                ...
                getFileRecords: function(e, c, d) {
                    var p = this,
                        h = [],
                        f = d.blob ? d.blob : d;
                    return new qq.Identify(f, t).isPreviewableSync() ? (qq.each(l, function(e, i) {
            ...
            var n = this,
                ...
                m = function(t) {
                    var n, a = t.fileOrBlob,
                        ...
                        p = t.params || {},
                        h = c.params || {},
                        f = s ? new FormData : null,
                        q = c.method || e.method,
                        m = c.endpoint || e.endpointStore.get(u),
                        g = i(u),
                        _ = o(u);
                    return e.omitDefaultParams ? (n = qq.extend({}, d), qq.extend(n, h)) : (n = qq.extend({}, d), qq.extend(n, h), qq.extend(n, p), n[e.uuidName] = r(u), n[e.filenameParam] = g, s ? n[e.totalFileSizeName] = _ : e.paramsInBody || (n[e.inputName] = g)), e.paramsInBody || (m = qq.obj2url(n, m)), l.open(q, m, !0), e.cors.expected && e.cors.sendCredentials && (l.withCredentials = !0), s ? (e.paramsInBody && qq.obj2FormData(n, f), f.append(e.inputName, a), f) : a
                },
                g = function(t) {
            ...
            qq.extend(this, {
                uploadChunk: function(t) {
                    var i, o, r, a = t.id,
                        ...
                        h = n._createXhr(a, s),
                        f = {};
                    return i = c(a, h), n._registerProgressHandler(a, s, p.size), r = e.paramsStore.get(a), u(a, f, p), d && (f[e.resume.paramNames.resuming] = !0), o = m({
                        fileOrBlob: p.blob,
                        id: a,
                        customParams: r,
                        params: f,
                ...
                return {
                    finalizeChunks: function(i) {
                        return t.onFinalizing(i), e.chunking.success.endpoint ? q(i) : n.finalizeChunks(i, qq.bind(f, this, !0))
                    }
                }
            })
        ...
        function() {
            ...
            var t, n, i, o, r, a, s, u, l = {
                ...
                S = function(e, n, i) {
                    var o = O(e);
                    return t("Generating new thumbnail for " + e), n.qqThumbnailId = e, q.imageGenerator.generate(n, o, i).then(function() {
                        d++, W(o), g[e].success()
                    }, function() {
                        g[e].failure(), q.placeholders.waitUntilUpdate || H(e, o)
                    })
                },
                w = function() {
                    if (h.length) {
                ...
                j = function() {
                    ...
                    if (o = qq.trimStr(o), a = document.createElement("div"), a.appendChild(qq.toElement(o)), _ = qq(a).getFirstByClass(m.uploader), q.button && (c = qq(a).getFirstByClass(m.button), c && qq(c).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (h = qq(a).getFirstByClass(m.dropProcessing), h && qq(h).remove()), d = qq(a).getFirstByClass(m.drop), d && !qq.DragAndDrop && (t("DnD module unavailable.", "info"), qq(d).remove()), qq.supportedFeatures.fileDrop ? qq(_).hasAttribute("qq-drop-area-text") && d && (g = qq(d).getFirstByClass(m.dropText), g && qq(g).remove()) : (_.removeAttribute("qq-drop-area-text"), d && qq(d).hasAttribute("qq-hide-dropzone") && qq(d).css({
                            display: "none"
                        })), p = qq(a).getFirstByClass(m.thumbnail), s ? p && (f = parseInt(p.getAttribute("qq-max-size")), f = f > 0 ? f : null, u = qq(p).hasAttribute("qq-server-scale")) : p && qq(p).remove(), s = s && p, n = qq(a).getByClass(m.editFilenameInput).length > 0, i = qq(a).getByClass(m.retry).length > 0, r = qq(a).getFirstByClass(m.list), null == r) throw new Error("Could not find the file list container in the template!");
                ...
                V = function(e) {
                    ...
                    if (o)
                        if (n) {
                            if (!(q.limits.maxThumbs && q.limits.maxThumbs <= d)) return i && y(o), q.imageGenerator.generate(n, o, r).then(function() {
                                W(o), d++, setTimeout(w, q.limits.timeBetweenThumbs)
                            }, function() {
                                H(t, o), setTimeout(w, q.limits.timeBetweenThumbs)
                            });
                            H(t, o), w()
                        } else H(t, o), w()
                },
                ...
                Q = function(e, n) {
                    ...
                    t(qq.format("ID {} is the same file as ID {}.  Will use generated thumbnail from ID {} instead.", e, n, n)), g[n].then(function() {
                        ...
                        g[e].failure(), q.placeholders.waitUntilUpdate || H(e, i)
                    })
                };
            qq.extend(q, e), t = q.log, qq.supportedFeatures.imagePreviews || (q.limits.timeBetweenThumbs = 0, q.limits.maxThumbs = 0), r = q.containerEl, s = void 0 !== q.imageGenerator, o = j(), b(), qq.extend(this, {
                render: function() {
                    t("Rendering template in DOM."), d = 0, r.appendChild(o.template.cloneNode(!0)), L(E()), this.hideTotalProgress(), a = q.fileContainerEl || N(r, m.list), t("Template rendering complete")
                },
                ...
                addFile: function(e, t, n, i, s) {
                    var u, d = o.fileTemplate.cloneNode(!0),
                        p = N(d, m.file),
                        h = N(r, m.uploader),
                        f = s ? l.content : a;
                    s && (l.map[e] = d), qq(d).addClass("qq-file-id-" + e), h.removeAttribute("qq-drop-area-text"), p && (qq(p).setText(t), p.setAttribute("title", t)), d.setAttribute("qq-file-id", e), n ? M(d, n.index, f) : f.appendChild(d), i ? (d.style.display = "none", qq(d).addClass("qq-hidden-forever")) : (L(R(e)), L(A(e)), L(I(e)), L(k(e)), L(T(e)), L(x(e)), c && this.hideCancel(e), u = O(e), u && !u.src && v.then(function(e) {
                ...
                uploadPaused: function(e) {
                    this.setStatusText(e, q.text.paused), this.allowContinueButton(e), L(B(e))
                },

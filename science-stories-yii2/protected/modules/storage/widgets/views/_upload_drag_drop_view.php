        ...
        <div class="qq-uploader-selector qq-uploader qq-gallery" qq-drop-area-text="<?= \Yii::t('app', 'Drop files here') ?>">
            ...
            <ul class="qq-upload-list-selector qq-upload-list" role="region" aria-live="polite" aria-relevant="additions removals">
                <li>
                 ...
                 <input class="qq-edit-filename-selector qq-edit-filename" tabindex="0" type="text">
                        <span class="qq-upload-size-selector qq-upload-url"></span>
...
//         },
        ...
        console.log("Error Uploading Your File" + responseJSON['error'] );
       
    }).on('complete', function (event, id, name, responseJSON) {
    console.log("Complete File:" + responseJSON['url'] );

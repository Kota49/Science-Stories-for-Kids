...
use app\modules\sitemap\models\search\Item as ItemSearch;
...
class ItemController extends TController
{
    ...
    public function actionClone($id)
    {
        ...
        $model->priority_id = $old->priority_id;
        $model->change_frequency_id = $old->change_frequency_id;
    ...
    /**
     * Truncate an existing Item model.
    ...
    public function actionClear($truncate = true)
    {
        ...
        \Yii::$app->session->setFlash('success', 'Item Cleared !!!');
        return $this->redirect([
            'index'
        ]);
    }
    ...
    protected function updateMenuItems($model = null)
    {
        switch (\Yii::$app->controller->action->id) {
            ...
            case 'index':
                {
                    $this->menu['sync'] = [
                        'label' => '<span class="glyphicon glyphicon-refresh"></span>Sync',
